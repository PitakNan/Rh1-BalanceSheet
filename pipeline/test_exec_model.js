...
{ const ok=Math.abs(sum-104.35e6)<1e5&&n===20;
  console.log('  เงินสนับสนุนรวม (เป้า 6):',M(sum),'·',n,'แห่ง  (ต้องเท่า 104.35M/20 แห่ง)',ok?'✅':'❌');
  if(!ok) fail.push(`เงินสนับสนุนรวมเปลี่ยน: ได้ ${M(sum)}/${n} แห่ง ควรเป็น 104.35M/20 แห่ง`); }
...
{ const want='0×30 1×16 2×9 3×18 4×3 5×4 6×3 7×20';   // 12 ส.ค. 69 หลังใส่ niProf (เดิม 0×26 1×20 2×11 3×14 4×5 5×3 6×9 7×15)
