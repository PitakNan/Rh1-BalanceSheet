...
{ const ok=Math.abs(sum-57.25e6)<1e5&&n===11;
  console.log('  เงินสนับสนุนรวม (เป้า 6):',M(sum),'·',n,'แห่ง  (ต้องเท่า 57.25M/11 แห่ง)',ok?'✅':'❌');
  if(!ok) fail.push(`เงินสนับสนุนรวมเปลี่ยน: ได้ ${M(sum)}/${n} แห่ง ควรเป็น 57.25M/11 แห่ง`); }
...
{ const want='0×36 1×17 2×14 3×13 4×5 5×3 6×4 7×11';
