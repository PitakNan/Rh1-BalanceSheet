...
{ const ok=Math.abs(sum-104.20e6)<1e5&&n===18;
  console.log('  เงินสนับสนุนรวม (เป้า 6):',M(sum),'·',n,'แห่ง  (ต้องเท่า 104.20M/18 แห่ง)',ok?'✅':'❌');
  if(!ok) fail.push(`เงินสนับสนุนรวมเปลี่ยน: ได้ ${M(sum)}/${n} แห่ง ควรเป็น 104.20M/18 แห่ง`); }
...
{ const want='0×30 1×19 2×9 3×14 4×4 5×3 6×6 7×18';   // 12 ส.ค. 69 หลัง niProf+clProf+เงินทุนหมุนเวียน
